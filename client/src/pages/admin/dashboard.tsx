...
import { Activity, Users, TestTube, FileText } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="container mx-auto py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Manage tests, bookings, and reports</p>
        </div>
